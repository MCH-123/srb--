...
export default {
  ...
  methods: {
    ...
    getBorrowInfoStatus(){
      ...
      .then((result) => {
        this.borrowInfoStatus = result.data.borrowInfoStatus
    ...
    initSelected() {
      ...
      this.$axios
        ...
        .then((result) => {
          this.returnMethodList = result.data.dictList;
        })
        .catch((err) => {});
      //资金用途列表
      this.$axios
        ...
        .then((result) => {
          this.moneyUseList = result.data.dictList;
        })
        .catch((err) => {});
    },
    //获取借款额度
    getBorrowAmount() {
      this.$axios
        ...
        .then((result) => {
          this.borrowAmount = result.data.borrowAmount;
        })
        .catch((err) => {});
    },
    //提交借款申请
